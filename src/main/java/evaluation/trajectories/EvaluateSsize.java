...
final public class EvaluateSsize {
    ...
    public static void main (String[] args) throws IOException {
        ...
        for (String network : networks) {
            ...
            ArrayList<ArrayList<Long>> trajectoriesR = loadTrajectories ("../queries/trajectories/"+network+"/"+distances[Index],1000);
            ...
            for (float distance : distances) {
                ...
                ArrayList<ArrayList<Long>> trajectoriesS = loadTrajectories ("../queries/trajectories/"+network+"/"+distance,100);

                for (int i=0; i<trajectoriesS.size();) {
