        ...
        for (String language : languages) {
            ...
            for (int resultsize : resultsizes) {
                ...
                try{
                    ...
                    ArrayList<ArrayList<String>> result = dp.retrieveSeeds (qcenter,numberseeds[I],resultsize,minsum,scores);
                    ...
                    checkResult (result,numberseeds[I],resultsize);

                    /***********************************/
                    /***********************************/

                    start = System.currentTimeMillis();
                    dp.processSeeds (qcenter,result,numberseeds[I],minsum,scores);
                ...
                System.out.println ("[ "+ resultsize + "\t " + summeddurationGreedy/1000.0f/Q + "\t " + summeddurationSwap/1000.0f/Q+ "\t " + summeddurationCoverage/1000.0f/Q 
