...
public class EvaluateBeta extends Evaluate {
    ...
    public static void main (String[] args) {
        ...
        for (String language : languages) {
            ...
            for (float beta : betas) {
                ...
                dp.setWeightParameters (.8f,.0f,beta);
                ...
                System.out.println ("[ "+ beta + "\t " + summeddurationGreedy/1000.0f/Q + "\t " + summeddurationSwap/1000.0f/Q+ "\t " + summeddurationCoverage/1000.0f/Q 
