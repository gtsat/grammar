...
public class EvaluateTimeOut extends Evaluate {
        ...
        for (String language : languages) {
            ...
            for (long timeout : timeouts) {
                ...
                try{
                    ...
                    ArrayList<ArrayList<String>> result = dp.retrieveSeeds (qcenter,numberseeds[I],resultsizes[I],minsum,scores,timeout);
                    ...
                    dp.processSeeds (qcenter,result,numberseeds[I],minsum,scores,timeout);
                ...
                System.out.println ("[ "+ timeout + "\t " + summeddurationGreedy/1000.0f/Q + "\t " + summeddurationSwap/1000.0f/Q
                                        + "\t " + summedscoreGreedy/Q + "\t " + summedscoreSwap/Q
                                        + "\t " + ((summedmemoryGreedy/Q)>>10) + "\t " + ((summedmemorySwap/Q)>>10) + " ]");
            }
        }
    }
}
