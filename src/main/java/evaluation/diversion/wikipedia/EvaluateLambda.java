...
public class EvaluateLambda extends Evaluate {
    ...
    public static void main (String[] args) {
        ...
        for (String language : languages) {
            ...
            for (float lambda : lambdas) {
                ...
                dp.setWeightParameters (lambda,.0f,.8f);
                ...
                try{
                    ...
                    ArrayList<ArrayList<String>> result = dp.retrieveSeeds (qcenter,numberseeds[I],resultsizes[I],minsum,scores);
                ...
                System.out.println ("[ "+ lambda + "\t " + summeddurationGreedy/1000.0f/Q + "\t " + summeddurationSwap/1000.0f/Q+ "\t " + summeddurationCoverage/1000.0f/Q 
