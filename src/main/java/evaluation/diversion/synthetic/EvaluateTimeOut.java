...
final class EvaluateTimeOut extends Evaluate {
    ...
    public static void main (String[] args) {
        ...
        for (long timeout : timeouts) {
            ...
            try{
                ...
                SwapDiversion.compute (qcenter,result,null,graph,context,numberseeds[I],minsum,symmetric,.8f,.0f,.8f,scores,timeout);
