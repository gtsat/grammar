...
final class EvaluateEdgesNumber extends Evaluate {
    ...
    public static void main (String[] args) {
        ...
        for (int edges : numberedges) {
            Graph<Integer> graph = new DirectedGraph<>();
            for (int i=0; i<Evaluate.numbernodes[I]; ++i) graph.addNode (i);
            graph.setErdosRenyiGraph ((float)edges/(graph.numberNodes()-1));
            ...
            System.out.println ("[ "+ edges + "\t " + summeddurationGreedy/1000.0f/Q + "\t " + summeddurationSwap/1000.0f/Q + "\t " + summeddurationCoverage/1000.0f/Q 
