...
final class EvaluateSeedsNumber extends Evaluate {
    ...
    public static void main (String[] args) {
        ...
        for (int i=0; i<Evaluate.numbernodes[I]; ++i) {
            graph.addNode (i);
        ...
        for (int seeds : Evaluate.numberseeds) {
            ...
            try{
                ...
                start = System.currentTimeMillis();
                SwapDiversion.compute (qcenter,result,null,graph,context,seeds,minsum,symmetric,.8f,.0f,.8f,scores);
