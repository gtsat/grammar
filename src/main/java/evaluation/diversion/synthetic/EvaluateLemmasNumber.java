...
final class EvaluateLemmasNumber extends Evaluate {
    ...
    public static void main (String[] args) {
        ...
        for (int lemmas : numberlemmas) {
            ...
            System.out.println ("[ "+ lemmas + "\t " + summeddurationGreedy/1000.0f/Q + "\t " + summeddurationSwap/1000.0f/Q+ "\t " + summeddurationCoverage/1000.0f/Q 
