...
public class EvaluateAlpha extends Evaluate {
    ...
    public static void main (String[] args) {
        ...
        for (String language : languages) {
            ...
            for (float alpha : alphas) {
                ...
                dp.setWeightParameters (0.5f,alpha,1.0f);
                ...
                System.out.println ("[ "+ alpha + "\t " + summeddurationGreedy/1000.0f/Q + "\t " + summeddurationSwap/1000.0f/Q
