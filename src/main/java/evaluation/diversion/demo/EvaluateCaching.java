...
public class EvaluateCaching extends Evaluate {
    ...
    public static void main (String[] args) {
        ...
        for (String language : languages) {
            ...
            for (int radius : radiuses) {
                ...
                System.out.println ("[ "+ radius + "\t " + summeddurationGreedy/1000.0f/Q + "\t " + summeddurationSwap/1000.0f/Q
