...
final public class ConnectingPointTargetEvaluator extends ConnectingPointEvaluator {

    public static void main (String[] args) throws IOException {
        if (targetless) {
            System.out.println ("\n!! ERROR - No point for this parameter to run under a targetless setting !!");
            return;
        }
        ...
        for (String network : networks) {
            ...
            for (float target : distances) {
                ...
                System.out.print ("["+target+"\t"+cpTime/Math.pow(10,9)/Qid+"\t"+hpTime/Math.pow(10,9)/Qid+"\t"+epTime/Math.pow(10,9)/Qid
