...
final public class ConnectingPointResultsEvaluator extends ConnectingPointEvaluator {
    ...
    public static void main (String[] args) throws IOException {
        ...
        for (String network : networks) {
            ...
            for (int k : results) {
                ...
                System.out.print ("["+k+"\t"+cpTime/Math.pow(10,9)/Qid+"\t"+hpTime/Math.pow(10,9)/Qid+"\t"+epTime/Math.pow(10,9)/Qid
