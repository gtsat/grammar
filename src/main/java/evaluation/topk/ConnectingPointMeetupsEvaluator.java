...
final public class ConnectingPointMeetupsEvaluator extends ConnectingPointEvaluator {
        ...
        for (String network : networks) {
            ...
            for (int M : meetups) {
                ...
                for (Long[] query : queries) {
                    ...
                    result = ComputeExtensiveGroupings.compute (grouping,graph,k,M,useMinSumRanking);
                ...
                for (Long[] query : queries) {
                    ...
                    startTime = System.nanoTime();
                    result = ComputeHeuristicGroupings.compute (grouping,graph,k,M,useMinSumRanking);
                ...
                for (Long[] query : queries) {
                    ...
                    startTime = System.nanoTime();
                    result = ComputeClusteredGroupings.compute (grouping,graph,k,M,useMinSumRanking);
                ...
                System.out.print ("["+M+"\t"+cpTime/Math.pow(10,9)/Qid+"\t"+hpTime/Math.pow(10,9)/Qid+"\t"+epTime/Math.pow(10,9)/Qid
