...
final public class EvaluateSsize {
    final static private int[] kappas = {20,40,60,80,100,120,140,160};
    final static private int[] parallelism = {2,4,6,8,10,12,14,160};
    final static private int[] partitions = {2,4,6,8,10,12,14,160};
    ...
    final static private String[] networks = {"NY"}; //{"NA","SF"};
    ...
    public static void main (String[] args) throws IOException {
        ...
        for (String network : networks) {
            ...
            for (float Ssize : datasizes) {
                while (Ssize*originalSsize>S.size()) S.remove();
                ...
                System.out.println("["+Ssize+" "+duration+"]");
            }
        }
    }
