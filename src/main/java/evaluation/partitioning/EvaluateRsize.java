...
final public class EvaluateRsize {
    ...
    final static private int[] parallelism = {2,4,6,8,10,12,14,16};
    final static private int[] partitions = {2,4,6,8,10,12,14,16};
    ...
    public static void main (String[] args) throws IOException {
        ...
        for (String network : networks) {
            ...
            for (float Rsize : datasizes) {
                while (Rsize*originalRsize>R.size()) R.remove();
                ...
                System.out.println("["+Rsize+" "+duration+"]");
            }
        }
    }
