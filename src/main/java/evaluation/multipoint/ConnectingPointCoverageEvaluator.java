...
final public class ConnectingPointCoverageEvaluator extends ConnectingPointEvaluator {
    ...
    public static void main (String[] args) throws IOException {
        ...
        for (String network : networks) {
            ...
            for (float area : coverages) {
                ...
                System.out.print ("["+area+"\t"+cpTime/Math.pow(10,9)/Qid+"\t"+hpTime/Math.pow(10,9)/Qid+"\t"+epTime/Math.pow(10,9)/Qid
