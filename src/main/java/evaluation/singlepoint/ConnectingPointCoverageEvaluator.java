...
import oscp.Group;
import setbased.ComputeMeetingLocationDijkstra;
...
final public class ConnectingPointCoverageEvaluator {
...
*/
                ...
                System.out.print ("["+area+"\t"+bnbTime/Math.pow(10,9)/Qid+"\t"+ceTime/Math.pow(10,9)/Qid+"\t"+relTime/Math.pow(10,9)/Qid+"\t"+postTime/Math.pow(10,9)/Qid+"\t"
