...
final public class ConnectingPointTravelerEvaluator {
...
*/
                ...
                System.out.print ("["+n+"\t"+bnbTime/Math.pow(10,9)/Qid+"\t"+ceTime/Math.pow(10,9)/Qid+"\t"+relTime/Math.pow(10,9)/Qid+"\t"+postTime/Math.pow(10,9)/Qid+"\t"
