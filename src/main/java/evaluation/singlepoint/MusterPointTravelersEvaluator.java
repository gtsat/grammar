...
final public class MusterPointTravelersEvaluator {
    ...
    public static void main (String[] args) throws IOException {
        ...
        System.out.println(" -----------------------------------");
        System.out.println("   Optimal osmp Point Evaluation  ");
        System.out.println(" -----------------------------------");
...
**/
                ...
                System.out.println ("!! Done processing "+Qid+" queries for "+n+" travelers !!");
